...
const FormAddTranslationOffer = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      <h2 className="font-bold mb-2 ml-2 text-2xl">{t("form.offerTranslations")}</h2>
      <p className="mb-4 ml-2 text-gray-500">{t("formDescription.translations")}</p>
