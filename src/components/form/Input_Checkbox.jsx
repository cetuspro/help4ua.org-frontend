    ...
    <div className="relative">
      <div className="flex items-center cursor-pointer p-2" onClick={()=>onChange(!value)}>
        <input
          ...
          onChange={onChange}
          type="checkbox"
          className="w-4 h-4 min-w-fit text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
          checked={!!value}
        />
