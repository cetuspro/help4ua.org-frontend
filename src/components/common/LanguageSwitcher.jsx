  ...
  return (
    <Menu as='div' className='relative inline-block text-left'>
      ...
      <Transition
        ...
        <Menu.Items
          className='absolute bg-gray-200 z-50 right-0 mt-2 origin-top-right divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'>
          <div  className='px-2 py-2 cursor-pointer lg:flex items-center gap-4 bg-gray-200 hover:bg-gray-300 rounded-md'  onClick={setLanguage(lng)}>
            {languages
              .filter(
              ...
              .map(({ lng, flag }) => (
                <div
                  key={lng}
                >
                  <img className="h-6" src={flag} alt={lng} />
                </div>
              ))}
          </div>
        </Menu.Items>
