...
export default function Contact() {
  ...
  return (
    <>
      <div className="items-center p-8 mx-auto md:mx-20 md:flex justify-center">
        <div className="flex-1 p-4 flex-start md:justify-end flex">
          <iframe
        ...
        <div className="flex-1 p-4 h-full md:flex md:text-center">
