...
const Register = () => {
  ...
  const mutation = useHookFormMutation(methods, register, { onSuccess, onError })
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        description="Rejestracja przebiegła pomyślnie. Na Twój adres email został przesłany link aktywujący konto."
