          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 xl:gap-16 md:px-10 py-2">
            <div className="flex flex-col items-center justify-center p-8 shadow-md rounded-3xl">
              ...
              <p className={'italic mb-4'}>
                Liczba aktywnych ogłoszeń: {!isFetching && data?.[1]?.statusAndAmount[2]?.amount}
              </p>
              <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
                <Button1
            ...
            <div className="flex flex-col items-center justify-center p-8 shadow-md rounded-3xl">
              ...
              <p className={'italic mb-4'}>
                Liczba aktywnych ogłoszeń: {!isFetching && data?.[2]?.statusAndAmount?.[2]?.amount}
              </p>
              <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
                <Button1
            ...
            <div className="flex flex-col items-center justify-center p-8 shadow-md rounded-3xl">
              ...
              <p className={'italic mb-4'}>
                Liczba aktywnych ogłoszeń: {!isFetching && data?.[3]?.statusAndAmount?.[2]?.amount}
              </p>
              <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
            ...
            <div className="flex flex-col items-center justify-center p-8 shadow-md rounded-3xl">
              ...
              <p className={'italic mb-4'}>
                Liczba aktywnych ogłoszeń: {!isFetching && data?.[4]?.statusAndAmount?.[2]?.amount}
              </p>
              <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
                <Button1
            ...
            <div className="flex flex-col items-center justify-center p-8 shadow-md rounded-3xl">
              ...
              <p className={'italic mb-4'}>
                Liczba aktywnych ogłoszeń: {!isFetching && data?.[6]?.statusAndAmount?.[2]?.amount}
              </p>
              <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
                <Button1
            ...
            <div className="flex flex-col items-center justify-center p-8 shadow-md rounded-3xl">
              ...
              <p className={'italic mb-4'}>
                Liczba aktywnych ogłoszeń: {!isFetching && data?.[5]?.statusAndAmount?.[2]?.amount}
              </p>
              <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
            ...
            <div className="flex flex-col items-center justify-center p-8 shadow-md rounded-3xl">
              ...
              <p className={'italic mb-4'}>Liczba aktywnych ogłoszeń: 6</p>
              <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start gap-2.5">
                <Button1
                  to={route['notices.addTemporaryAnimalHome']}
                  label={t('frontpage.addNotice')}
                />
                <Button2 to={route['notices.list5']} label={`${t('frontpage.seeNotices')} (6)`} />
              </div>
              <p className="max-w-screen-md text-gray-600 mb-2 text-sm mt-6 text-center mx-auto">
