  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={mutation.mutate}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-2">
          <div>
            <InputCheckbox name="isAcceptedChild" label={t('form.isAcceptedChild')} />
          </div>
          <div>
            <InputCheckbox name="isAcceptedAnimal" label={t('form.isAcceptedAnimal')} />
          </div>
          <div>
            <InputCheckbox name="isCatering" label={t('form.isCatering')} />
          </div>
        </div>
