...
import { FaUser, FaComment, FaMapPin, FaCheck } from 'react-icons/fa'
    ...
    <FormProvider {...methods}>
      <form onSubmit={mutation.mutate}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-2">
          ...
          <div>
            <InputText name="localization.latitude" label={t('form.latitude')} icon={FaMapPin} />
          </div>
          <div>
            <InputText name="localization.longitude" label={t('form.longitude')} icon={FaMapPin} />
          </div>
        </div>
        <div>
